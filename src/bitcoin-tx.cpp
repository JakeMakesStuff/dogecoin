...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s logecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  logecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded logecoin transaction") + "\n" +
              "  logecoin-tx [options] -create [commands]   " + _("Create hex-encoded logecoin transaction") + "\n" +
              "\n";
