...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Logecoin v2 blocks, so we enforce from v3
        ...
        // consensus.BIP65Height = 1032483; // Not enabled in Loge yet
        ...
        // XXX: BIP heights and hashes all need to be updated to Logecoin values
        ...
        vSeeds.push_back(CDNSSeedData("multiloge.org", "seed.multiloge.org", true));
        vSeeds.push_back(CDNSSeedData("multiloge.org", "seed2.multiloge.org"));
        ...
        //TODO: fix this for logecoin -- plddr
